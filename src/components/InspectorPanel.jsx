                ...
                <>
                  ...
                  <div className="inspector-row">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onUpdateObject(selectedObject.id, {
                          decay: parseFloat(e.target.value) || 1,
                        })
                      }
                    />
                  </div>
                ...
                <>
                    ...
                    <input
                      ...
                      value={
                        selectedObject.angle
                          ? ((selectedObject.angle * 180) / Math.PI).toFixed(1)
                          : 45
                      }
                      min={0}
                      max={90}
                      ...
                      onChange={(e) =>
                        onUpdateObject(selectedObject.id, {
                          angle: (parseFloat(e.target.value) * Math.PI) / 180 || Math.PI / 4,
                        })
                      }
                    />
                  </div>
                  <div className="inspector-row">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onUpdateObject(selectedObject.id, {
                          penumbra: parseFloat(e.target.value) || 0,
                        })
                      }
                    />
                  </div>
          ...
          {(selectedObject.type === 'sphere' || selectedObject.type === 'plane') && (
            <div className="inspector-row">
              ...
              <select
                ...
                onChange={(e) =>
                  handleTextureChange(e.target.value ? parseInt(e.target.value) : null)
                }
              >
                <option value="">{msg('inspector.noTexture')}</option>
                {textureAssets.map((asset) => (
              ...
              {selectedObject.textureId != null && (
                <>
                  <Vector2Field
                    ...
                    fallback={[1, 1]}
                    onChange={(i, v) => handleUVChange('uvScale', i, v)}
                    min="0.01"
                  />
                  <Vector2Field
                    ...
                    fallback={[0, 0]}
                    onChange={(i, v) => handleUVChange('uvOffset', i, v)}
                  />
                </>
              )}
            </div>
