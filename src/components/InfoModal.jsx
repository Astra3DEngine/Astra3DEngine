...
function InfoModal({ isOpen, onClose, type }) {
    ...
    <div className="info-content about-content">
      ...
      <section className="info-section">
        ...
        <div className="about-links">
          <a
            href="https://github.com/LanwyWriteXU/Astra3DEngine"
            target="_blank"
          ...
          <a
            href="https://github.com/LanwyWriteXU/Astra3DEngine/issues"
            target="_blank"
            rel="noopener noreferrer"
          >
      ...
      <section className="info-section">
        ...
        <ul className="credits-list">
          <li>
            ...
            <a href="https://cyberneko.cn" target="_blank" rel="noopener noreferrer">
              Cyberexplorer
            </a>
          </li>
          <li>
            <span className="credit-role">[{msg('info.about.credit.support1')}]</span>
            <a href="https://github.com/KOSHINOawa" target="_blank" rel="noopener noreferrer">
              KOSHINO
            </a>
          </li>
          <li>
            <span className="credit-role">[{msg('info.about.credit.support2')}]</span>
            <a href="https://github.com/NeuronPulse" target="_blank" rel="noopener noreferrer">
              NeuronPulse
            </a>
          </li>
        </ul>
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={titles[type]} width={480}>
      <div className="info-content">{contents[type]}</div>
    </Modal>
  );
}
